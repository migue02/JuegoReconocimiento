...
public class EjercicioDataSource {
	...
	private ContentValues createValues(Ejercicio ejercicio) {
		...
		values.put(MySQLiteHelper.COLUMN_EJERCICIO_NOMBRE,
				ejercicio.getNombre());
		values.put(MySQLiteHelper.COLUMN_EJERCICIO_OBJETOS,
				JSONParser.ArrayListToJson(ejercicio.getObjetos()));
		values.put(MySQLiteHelper.COLUMN_EJERCICIO_DESCRIPCION,
				ejercicio.getDescripcion());
		values.put(MySQLiteHelper.COLUMN_EJERCICIO_FECHA,
				ejercicio.getFechaAsString());
		values.put(MySQLiteHelper.COLUMN_EJERCICIO_DURACION,
				ejercicio.getDuracion());
		values.put(MySQLiteHelper.COLUMN_EJERCICIO_OBJETOS_REC,
				JSONParser.ArrayListToJson(ejercicio.getObjetosReconocer()));
		values.put(MySQLiteHelper.COLUMN_EJERCICIO_SONIDO_DESCRIPCION,
				ejercicio.getSonido_descripcion());
		return values;
	}
	...
	public Ejercicio createEjercicio(String nombre, Date fecha,
			ArrayList<String> objetos, String descripcion, int duracion,
	...
	public boolean modificaEjercicio(String nombre, Date fecha,
			ArrayList<String> objetos, String descripcion, int duracion,
			ArrayList<String> objetosReconocer, String sonido_descripcion) {

		ContentValues values = new ContentValues();
		Ejercicio ejercicio = new Ejercicio(nombre, new Date(), objetos,
				descripcion, duracion, objetosReconocer, sonido_descripcion);
		values = createValues(ejercicio);

		boolean mod = database.update(MySQLiteHelper.TABLE_EJERCICIO, values,
				MySQLiteHelper.COLUMN_EJERCICIO_NOMBRE + " = " + "'" + nombre
						+ "'", null) > 0;
	 ...
	 * 
	 * ContentValues values = new ContentValues(); Ejercicio ejercicio = new
	 * Ejercicio(-1, nombre, objetos, descripcion, duracion, objetos); values =
	 * createValues(ejercicio);
	 * 
	 * return database.update(MySQLiteHelper.TABLE_EJERCICIO, values,
	...
	public List<Ejercicio> getAllEjercicios() {
		Cursor cursor = database.query(MySQLiteHelper.TABLE_EJERCICIO,
				...
				MySQLiteHelper.COLUMN_EJERCICIO_ORDEN);
	...
	public Ejercicio getEjercicios(String nombre) {
		Cursor cursor = database.query(MySQLiteHelper.TABLE_EJERCICIO,
				allColumns, MySQLiteHelper.COLUMN_EJERCICIO_NOMBRE + " = "
	...
	public int getDuracion(int id) {
		Cursor cursor = database.query(MySQLiteHelper.TABLE_EJERCICIO,
				...
				MySQLiteHelper.COLUMN_EJERCICIO_ID + " = " + id, null, null,
				null, null);
		if (cursor != null && cursor.getCount() > 0) {
			cursor.moveToFirst();
	...
	public boolean actualizaOrden(Ejercicio ejercicio, int posicion) {
		...
		return database.update(
				MySQLiteHelper.TABLE_EJERCICIO,
				values,
				MySQLiteHelper.COLUMN_EJERCICIO_ID + " = "
						+ ejercicio.getIdEjercicio(), null) > 0;
	}
	...
	private Ejercicio cursorToEjercicio(Cursor cursor) {
		...
		ejercicio.setObjetos(JSONParser.ArrayListFromJson(cursor.getString(3)));
		try {
			ejercicio.setFecha(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss")
		...
		ejercicio.setObjetosReconocer(JSONParser.ArrayListFromJson(cursor
				.getString(6)));
