...
public class ResultadoSerie extends Activity {
	...
	public void creaGrafica(int i){
		...
		View child = getLayoutInflater().inflate(R.layout.layout_resultado_serie, null);
		//item.addView(child);
		
				
		oResultado = lResultados.get(i);

		((TextView) child.findViewById(R.id.tPosicion)).setText("Resultado("+String.valueOf(i+1)+"/"+lResultados.size()+")");
		
		TextView puntuacion=((TextView) child.findViewById(R.id.tPuntuacion));
		puntuacion.setText("PUNTUACION: "+String.valueOf(oResultado.getPuntuacion()));
		
		TextView totales=((TextView) child.findViewById(R.id.tTotales));
		totales.setTextColor(Color.BLUE);
		totales.setText("Total: "+String
				.valueOf(oResultado.getAciertos()+oResultado.getFallos()));
		
		TextView aciertos=((TextView) child.findViewById(R.id.tAciertos));
		aciertos.setTextColor(Color.GREEN);
		aciertos.setText("Aciertos: "+String
				.valueOf(oResultado.getAciertos()));;
		
		TextView fallos=((TextView) child.findViewById(R.id.tFallos));
		fallos.setTextColor(Color.RED);
		fallos.setText("Fallos: "+String
				.valueOf(oResultado.getFallos()));
		
		TextView duracion=((TextView) child.findViewById(R.id.tDuracion));
				duracion.setText("Duración: "+String
				.valueOf(oResultado.getDuracion())+" minuto(s)");
		
		
		
	    double[] values = new double[] { lResultados.get(i).getAciertos(), lResultados.get(i).getFallos() };
