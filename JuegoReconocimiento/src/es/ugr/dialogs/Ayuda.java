...
public class Ayuda extends Dialog {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		switch (nFragmentActivo) {
		case 1:
			titulo = "Gestión Alumnos";
			tit.setTextColor(getContext().getResources().getColor(
					R.color.verde_ic));
			tit.setText(titulo);
			...
			tv.setText(st);
			Picasso.with(getContext()).load(R.drawable.alumnos_64).into(imagen);
			break;
		...
		case 2:
			...
			tv.setText(st);
			Picasso.with(getContext()).load(R.drawable.resultados_64)
					.into(imagen);
			break;
		...
		case 3:
			...
			tv.setText(st);
			Picasso.with(getContext()).load(R.drawable.ejercicios_64)
					.into(imagen);
			break;
		...
		case 4:
			...
			tv.setText(st);
			Picasso.with(getContext()).load(R.drawable.series_64).into(imagen);
			break;
		...
		case 5:
			...
			tv.setText(st);
			Picasso.with(getContext()).load(R.drawable.objetos_64).into(imagen);
			break;
